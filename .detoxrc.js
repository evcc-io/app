...
module.exports = {
  ...
  apps: {
    "ios.release": {
      ...
      build:
        "xcodebuild -workspace ios/evcc.xcworkspace -scheme evcc -configuration Release -sdk iphonesimulator -derivedDataPath ios/build -quiet | xcbeautify --renderer github-actions",
    },
    "android.release": {
      launchArgs,
      type: "android.apk",
